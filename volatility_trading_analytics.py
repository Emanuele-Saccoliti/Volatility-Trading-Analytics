import tkinter as tk # we wil luse this to build the frame of our dashboard
from tkinter import ttk, messagebox, scrolledtext
import threading
import time
import pandas as pd # we will use pandas to handle data, espcially for implied volatility
import matplotlib as plt #to visualize the regression
...
# we create a class to manage the connection to IBKR
# and this is gonna be an implementation of the EWrapper and EClient classes from ibapi
...
class VolatilityCrushAnalyzer:
    ...
    def setup_current_greeks_section(self, parent, row):
        ...
        greeks_frame = ttk.LabelFrame(parent, text="♠️ Current Greeks", padding="10")
    ...
    def setup_new_greeks_section(self, parent, row):
        ...
        new_greeks_frame = ttk.LabelFrame(parent, text="♦️ New Scenario Greeks", padding="10")
